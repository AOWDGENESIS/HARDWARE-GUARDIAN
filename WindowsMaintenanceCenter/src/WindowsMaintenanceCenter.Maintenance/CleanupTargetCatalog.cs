...
public static class CleanupTargetCatalog
{
    ...
    private static string ResolveRoot(string id) => id switch
    {
        ...
        "WindowsTemp" => Combine(Environment.SpecialFolder.Windows, "Temp"),
        "WindowsUpdateDownload" => Combine(Environment.SpecialFolder.Windows, @"SoftwareDistribution\Download"),
        "CrashDumps" => Combine(Environment.SpecialFolder.LocalApplicationData, "CrashDumps"),
        "WerMachineArchive" => Combine(Environment.SpecialFolder.CommonApplicationData, @"Microsoft\Windows\WER\ReportArchive"),
        "WerMachineQueue" => Combine(Environment.SpecialFolder.CommonApplicationData, @"Microsoft\Windows\WER\ReportQueue"),
        "WerUserArchive" => Combine(Environment.SpecialFolder.LocalApplicationData, @"Microsoft\Windows\WER\ReportArchive"),
        "ExplorerThumbnails" => Combine(Environment.SpecialFolder.LocalApplicationData, @"Microsoft\Windows\Explorer"),
        "NvidiaDxCache" => Combine(Environment.SpecialFolder.LocalApplicationData, @"NVIDIA\DXCache"),
        "NvidiaGlCache" => Combine(Environment.SpecialFolder.LocalApplicationData, @"NVIDIA\GLCache"),
        "AmdDxCache" => Combine(Environment.SpecialFolder.LocalApplicationData, @"AMD\DxCache"),
        "EdgeCache" => Combine(Environment.SpecialFolder.LocalApplicationData, @"Microsoft\Edge\User Data\Default\Cache"),
        "ChromeCache" => Combine(Environment.SpecialFolder.LocalApplicationData, @"Google\Chrome\User Data\Default\Cache"),
        "FirefoxCache" => Combine(Environment.SpecialFolder.LocalApplicationData, @"Mozilla\Firefox\Profiles"),
        "Prefetch" => Combine(Environment.SpecialFolder.Windows, "Prefetch"),
        "WindowsInstaller" => Combine(Environment.SpecialFolder.Windows, "Installer"),
