...
/// <summary>
/// Allow list of the only PowerShell command templates Windows Maintenance Center may execute.
...
public static class PowerShellCommandCatalog
{
    ...
    private static readonly Dictionary<string, string> Templates = new(StringComparer.Ordinal)
    {
        ...
        // ClientApplicationID makes Windows Maintenance Center identifiable in the Windows Update log - that is
        ...
        [WindowsUpdateSession] =
            ...
            "$session.ClientApplicationID = 'WindowsMaintenanceCenter'; " +
