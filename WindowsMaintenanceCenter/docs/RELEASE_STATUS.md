...
| Gate 2 Unit | M00-M48 | 206 Testfälle geschrieben, nie ausgeführt | `tests/WindowsMaintenanceCenter.Tests`, TRX fehlt | `scripts/test.ps1` (verlangt TRX und mindestens 120 Fälle), Ergebnis nach `test-results/unit/` |
