...
| Gate 2 Unit | `test-results/unit/20260922T062120Z-359-of-359/`: TRX mit 359 Ergebnissen, `summary.txt` mit Zeitpunkt, Version, Build, Umgebung, Ergebnis; `scripts/test.ps1` verlangt TRX und mindestens 359 Fälle | **bestanden (CI-Umgebung)** |
