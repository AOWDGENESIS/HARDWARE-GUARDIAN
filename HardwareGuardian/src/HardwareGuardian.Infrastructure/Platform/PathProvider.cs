...
/// Installed mode: machine data below %ProgramData%\HardwareGuardian, user data below
/// %LocalAppData%\HardwareGuardian. No drive letter is ever assumed.
/// </summary>
public sealed class PathProvider : IPathProvider, IEnvironmentProbe
{
    private const string ProductFolderName = "HardwareGuardian";
    private const string PortableMarkerFileName = "HardwareGuardian.portable";
