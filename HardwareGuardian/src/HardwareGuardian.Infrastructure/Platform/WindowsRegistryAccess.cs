...
/// <summary>
/// Registry access limited to what Hardware Guardian needs (spec section 18: there is no
...
{
    /// <summary>Keys that Hardware Guardian is allowed to write to.</summary>
    public const string OwnKeyRoot = @"Software\HardwareGuardian";
