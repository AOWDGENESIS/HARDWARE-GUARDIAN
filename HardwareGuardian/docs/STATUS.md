...
Tool numbers after this session: 121 files / 380 declared types, 677 localisation keys per language,
...
| `tools/check-localization.py` | every key used in C# **or XAML** exists in both languages; no unused key; both files symmetric | 677 keys, 0 missing, 0 unused |
