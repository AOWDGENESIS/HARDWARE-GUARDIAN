...
Tool numbers after this session: 127 files / 392 declared types, 697 localisation keys per language,
...
| `tools/check-localization.py` | every key used in C# **or XAML** exists in both languages; no unused key; both files symmetric | 697 keys, 0 missing, 0 unused |
