...
How to start
------------
Double-click HardwareGuardian.exe. The application starts, scans the machine and
...
Installed mode: %ProgramData%\HardwareGuardian (machine wide) and
%LocalAppData%\HardwareGuardian (per user).
The marker file "HardwareGuardian.portable" next to the executable selects portable
