...
SOURCE_FILE = ROOT / "src" / "HardwareGuardian.Manufacturer" / "ManufacturerSources.cs"
...
USER_AGENT = "HardwareGuardian-SourceCheck/1.0 (+offline-first diagnostics tool; URL reachability only)"
